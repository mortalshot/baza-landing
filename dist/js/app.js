(() => {
    ...
    if (inputs.length > 0) inputs.forEach((element => {
    ...
    if (mails.length > 0) mails.forEach((element => {
        element.addEventListener("input", (function() {
    ...
    if (formAdd.length > 0) formAdd.forEach((element => {
        let clickCount = 1;
    ...
    document.addEventListener("selectCallback", (function(e) {
        ...
        if (currentSelect.classList.contains("form__city")) {
            ...
            if (element) element.classList.add("_active");
        }
    }));
